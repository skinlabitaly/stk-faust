...
brightnessFactor = hslider("v:Physical Parameters/Brightness Factor",0,0,1,0.01);
detuningFactor = hslider("v:Physical Parameters/Detuning Factor",0.1,0,1,0.01)*10;
stiffnessFactor = hslider("v:Physical Parameters/Stiffness Factor",0.28,0,1,0.01)*3.7;
hammerHardness = hslider("v:Physical Parameters/Hammer Hardness",0.1,0,1,0.01)*0.1;
...
(*(conditionHighNote) : hiPass : dcBlock1 : hammer : dcBlock2a : highBqs : dcBlock2b) :> + : *(2.5) : stereo;