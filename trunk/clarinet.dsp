...
process = hgroup("STK clarinet",
	(vgroup("[1]Differential Pressure",
	vgroup("Commuted Loss Filtering",oneZero*-0.95) - breathPressure) <: 
	vgroup("[2]Non-linear scattering",reed(reedTableOffset,reedTableSlope)*_ + breathPressure)) ~ 					vgroup("Delay with feedback",delay(4096,delayLength))); 