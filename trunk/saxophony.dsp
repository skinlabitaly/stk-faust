...
process = hgroup("Wave Guide Saxophone",
	vgroup("[1]Body Filter",(bodyFilter) <: 
	vgroup("[2]Saxophone Body",instrumentBody)) ~ 
	vgroup("[3]Delay Line",delay1) : !,
	vgroup("[4]Scaling Output",_*0.3));