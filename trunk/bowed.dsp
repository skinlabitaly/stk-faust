...
process = hgroup("STK Bowed Instrument",
	vgroup("[1]Instruement Body",instrumentBody) ~ 
	vgroup("[2]Bridge Delay",delay(4096,fdelbridge)) : 
	vgroup("[3]Body Filter",bodyFilter(_*0.2)));