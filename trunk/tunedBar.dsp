declare name "Banded Waveguide Modeled Tuned Bar";
...
modes0 = 1;
modes1 = 4.0198391420;
modes2 = 10.7184986595;
modes3 = 18.0697050938;
...
process = hgroup("Tuned Bar",
		(vgroup("Bowed Excitation",input*((select-1)*-1)) <: 
		resonance0(_)~_,resonance1(_)~_,resonance2(_)~_,resonance3(_)~_) ~(_,_,_,_) :> + : 
		vgroup("Signal Scaling",_*4));