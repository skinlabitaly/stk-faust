...
interpFactor = hslider("v:Physical Parameters/interpFactor",0.999,0,0.999,0.001);
...
voicedEnvelopeAttack = hslider("v:Voiced Sounds Envelope Parameters/envelopeAttack",0.01,0,2,0.01);
voicedEnvelopeRelease = hslider("v:Voiced Sounds Envelope Parameters/envelopeRelease",0.01,0,2,0.01);

noiseEnvelopeAttack = hslider("v:Fricative Sounds Envelope Parameters/envelopeAttack",0.001,0,2,0.001);
noiseEnvelopeRelease = hslider("v:Fricative Sounds Envelope Parameters/envelopeRelease",0.001,0,2,0.001);
...
formSwep(frequency,radius,filterGain) = _*gain_ : bandPass(frequency_,radius)
	with{
...
voiced = rdtable(impuls20TableSize, impuls20, int(phaser)) : _*voiceGain*voicedEnvelope
	with{
