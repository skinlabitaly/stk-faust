...
% - from DAFx-10 to DAFx-11 by Geoffroy Peeters 2011-01-31
%
...
\def\papertitle{Templates for DAFx-11, Paris, France}
...
%{\href{http://dafx11.ircam.fr}{Institut de Recherche et Coordination Acoustique/ Musique} \\ Centre Pompidou \\ Paris, France\\
%{\tt \href{mailto:dafx11@ircam.fr}{dafx11@ircam.fr}}
%}
...
%{\href{http://dafx10.iem.at}{Institute of Electronic Music and Acoustics,} \\ University of Music and Performing Arts \\ Graz, Austria\\
%{\tt \href{mailto:dafx10@iem.at}{dafx10@iem.at}}
%}
...
%{\href{http://dafx11.ircam.fr}{Spinning Group, Dept.~of Turning Sciences} \\ Univ.~of Planets, Mars \\ {\tt \href{mailto:dafx11@ircam.fr}{dafx11@ircam.fr}}
%}
...
{\paperauthorC,\sthanks{She is a member of the Wheel Association}}
{\href{http://dafx11.iem.at}{Spinning Group, Dept.~of Turning Sciences} \\ Univ.~of Planets, Mars \\ {\tt \href{mailto:dafx11@ircam.fr}{dafx11@ircam.fr}}
}
{\paperauthorD,\sthanks{Yes, senior}}
{\href{http://dafx11.ircam.fr}{Unknown Group, Dept.~of Volatile Sciences} \\ Univ.~of Nowhere, Somewhere \\ {\tt \href{mailto:dafx11@ircam.fr}{dafx11@ircam.fr}}
}
...
\begin{abstract}
  ...
  14$^{\text{th}}$ International Conference on Digital Audio Effects
  (DAFx-11).  This template has been generated from WASPAA'99
  templates and aims at producing conference proceedings in electronic
  form.  The format is essentially the one used for ICASSP
  conferences.  Please use either this \LaTeX{} or the accompanying
  Word formats when preparing your submission.  The templates are
  available in electronic form on the following website: \\
  \href{http://dafx11.ircam.fr}{http://dafx11.ircam.fr}. Thanks!
...
\begin{figure*}[ht]
\center
\includegraphics[width=5in,bb = 3 257 607 534]{TwoColumnSine2.eps} % The bounding box is set manually in this example. Useful for some .pdf figures.
