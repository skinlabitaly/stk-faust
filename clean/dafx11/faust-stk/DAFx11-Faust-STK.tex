...
\ref{fig:flute}. It uses a two loops
...
A simple model of a brass instrument inspired from a class of the {\it Synthesis
  ToolKit} and with a mouthpiece based on the model presented in
...
makes it possible to create nonlinear behavior when they are used in
