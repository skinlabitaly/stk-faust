...
vibratoGain = hslider("v:Vibrato Parameters/vibratoGain",0.01,0,1,0.01);
...
instrumentBody(feedBckBridge) = (_*-1 <: _ + feedBckBridge,_ : (bowVelocity-_ <: bowTable*_ <: _,_),_ : 
	_,_+_ : _ + feedBckBridge,_) ~ (neckDelay) : !,_;

stereo = stereoizer(SR/freq);

process = (stringFilter : instrumentBody) ~ (bridgeDelay : NLFM) : bodyFilter(_*0.2) : 
	_*gain : stereo;